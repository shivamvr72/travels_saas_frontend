...
export const reportKeys = {
  ...
  expensesTrend: (g: string, f: any) => [...reportKeys.all, 'expenses', 'trend', g, f] as const,
  expensesByVehicle: (f: any) => [...reportKeys.all, 'expenses', 'by-vehicle', f] as const,
  expensesByDriver: (f: any) => [...reportKeys.all, 'expenses', 'by-driver', f] as const,
  expensesSummaryKpis: (f: any) => [...reportKeys.all, 'expenses', 'summary-kpis', f] as const,
  profitabilitySummaryKpis: (f: any) => [...reportKeys.all, 'profitability', 'kpis', f] as const,
  profitabilityTrend: (g: string, f: any) => [...reportKeys.all, 'profitability', 'trend', g, f] as const,
  profitabilityByVehicle: (f: any) => [...reportKeys.all, 'profitability', 'by-vehicle', f] as const,
  profitabilityByDriver: (f: any) => [...reportKeys.all, 'profitability', 'by-driver', f] as const,
  profitabilityByCustomer: (f: any) => [...reportKeys.all, 'profitability', 'by-customer', f] as const,
  profitabilityByRoute: (f: any) => [...reportKeys.all, 'profitability', 'by-route', f] as const,
  fleet: (f: any) => [...reportKeys.all, 'fleet', f] as const,
  fleetKpis: (f: any) => [...reportKeys.all, 'fleet', 'kpis', f] as const,
  fleetUtilizationTrend: (g: string, f: any) => [...reportKeys.all, 'fleet', 'utilization-trend', g, f] as const,
  drivers: (f: any) => [...reportKeys.all, 'drivers', f] as const,
  driverKpis: (f: any) => [...reportKeys.all, 'driver-kpis', f] as const,
  driverPerformanceTrend: (g: string, f: any) => [...reportKeys.all, 'driver-trend', g, f] as const,
